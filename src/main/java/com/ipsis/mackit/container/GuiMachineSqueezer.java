...
public class GuiMachineSqueezer extends GuiBase {
	...
	private static final String TEXTURE_STR = Reference.MOD_ID.toLowerCase() + ":textures/gui/machineSqueezer.png";
	private static final String PROGRESS_TEXTURE_STR = Reference.MOD_ID.toLowerCase() + ":textures/gui/progress.png";
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID.toLowerCase(), "textures/gui/" + "machineSqueezer.png");
	...
	public void initGui() {
		...
		addTab(new TabInfo(this, "Squeeze all the things into liquid dye"));
	}
