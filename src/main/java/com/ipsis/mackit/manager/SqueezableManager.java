...
public class SqueezableManager {

	private HashMap<Integer, SqueezableRecipe> recipes;
	
	public SqueezableManager() {
		
		recipes = new HashMap<Integer, SqueezableRecipe>();
	...
	private void addRecipe(ItemStack source, ItemStack dye) {
		...
		recipes.put(ItemHelper.getHashCode(source), new SqueezableRecipe(source, dye));
	}
	
	public SqueezableRecipe getRecipe(ItemStack source) {
