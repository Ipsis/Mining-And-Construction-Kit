package com.ipsis.cofhlib.inventory;
...
public class InventoryManagerSided extends InventoryManagerStandard {
	...
	public InventoryManagerSided(ISidedInventory inventory,
	...
	public boolean canAddItem(ItemStack stack, int slot) {
		...
		return super.canAddItem(stack, slot)
				&& _sidedInv.canInsertItem(slot, stack, _targetSide.ordinal());
	}
