...
public class Strings {
	...
	public static final String BLOCK_DYE_MACHINE = "dyeMachine";
	public static final String BLOCK_DYE_TRANSPOSER = "dyeTransposer";
	public static final String BLOCK_DYE_TRANSPOSER_NAMES[] = { "dyeTransposer", "dyeTransposer_off", "dyeTransposer_on"  };
	
	public static final String BLOCK_WATER_FILLER = "waterFiller";
	public static final String BLOCK_WATER_FILLER_MODES[] = { "waterFiller_circle", "waterFiller_pyramid", "waterFiller_col7", "waterFiller_col11" };
	...
	public static final String MACKIT_PORTABLE_CASING_NAME = "mackitPortableCasing";
	...
	public static final String DIFFUSER_HEAD_NAME = "diffuserHead";
