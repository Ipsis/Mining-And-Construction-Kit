package ipsis.mackit.core.util;
...
public class LogHelper {
	...
	private static Logger mkLogger = Logger.getLogger(Reference.MOD_ID);
	
	public static void init() {
		
		mkLogger.setParent(FMLLog.getLogger());
	}
	
	public static void log(Level logLevel, Object object) {
		
		mkLogger.log(logLevel, object.toString());
	}
